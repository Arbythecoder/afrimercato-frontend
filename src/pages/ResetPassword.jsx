    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-afri-green to-afri-green-dark flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 max-w-md w-full text-center"
        >
          ...
          <Link
            to="/forgot-password"
            className="inline-block bg-afri-green hover:bg-afri-green-dark text-white font-semibold py-3 px-6 rounded-lg transition-all"
          >
            Request New Link
          </Link>
        </motion.div>
