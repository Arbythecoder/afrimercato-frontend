...
import { User, MapPin, Lock, Shield, Settings, Eye, EyeOff } from 'lucide-react'
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:ring-afri-green"
                      />
                      <button
                        type="button"
