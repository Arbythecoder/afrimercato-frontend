    ...
    return (
        <div className="min-h-screen bg-slate-50 pb-8">
            ...
            <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-800 px-5 pt-14 pb-28 rounded-b-[2.5rem] relative overflow-hidden">
                ...
                <h1 className="relative text-white text-2xl font-bold">Payout Settings</h1>
                <p className="relative text-orange-200 text-sm mt-0.5">Manage your UK bank account for payouts</p>
            </div>

            {/* Content — pulled up to overlap the hero's pb-28 */}
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400/20 focus:border-orange-500 outline-none transition-all text-gray-900 placeholder-gray-400"
                                />
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        maxLength="8"
                                        className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400/20 focus:border-orange-500 outline-none transition-all font-mono text-gray-900 placeholder-gray-400 tracking-wide"
                                    />
                                </div>
                            </div>

                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1.5">Sort code</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400/20 focus:border-orange-500 outline-none transition-all font-mono text-gray-900 placeholder-gray-400 tracking-widest"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-2 flex justify-end">
                            <button
                                type="submit"
                                disabled={saving}
                                className="px-5 py-2.5 bg-orange-500 hover:bg-orange-600 active:scale-[0.98] text-white text-sm font-semibold rounded-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 min-w-[130px] justify-center"
                            >
                                {saving ? (
                                    <>
