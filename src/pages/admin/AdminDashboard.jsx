                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-afri-gray-50">
                      {stats.recentOrders.map(order => {
                        ...
                        const vendorNames = order.items?.length > 0
                          ? [...new Map(order.items.map(i => [i.vendor?._id, i.vendor?.storeName])).values()]
                            .filter(Boolean)
                            .join(', ')
                          : 'N/A'
                        ...
                        return (
                          <tr key={order._id} className="hover:bg-afri-gray-50 transition-colors">
                            ...
                            <td className="px-5 py-3.5 font-medium text-afri-gray-900">
                              {order.customer?.name || 'N/A'}
                            </td>
                            <td className="px-5 py-3.5 text-gray-500 hidden md:table-cell">
                              {vendorNames}
                            </td>
                            <td className="px-5 py-3.5 font-bold text-afri-gray-900">
