        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className={`px-4 py-2 font-medium rounded-lg transition-colors ${activeTab === 'overview'
            ...
            <button
              ...
              className={`px-4 py-2 font-medium rounded-lg transition-colors ${activeTab === 'analytics'
                ? 'bg-afri-green text-white'
                : 'text-gray-600 hover:text-afri-green hover:bg-gray-50'
                }`}
            >
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            ...
                            <span className={`ml-2 ${metric.status === 'success' ? 'text-green-600' :
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.metric} className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className={`text-sm font-medium ${item.status === 'success' ? 'text-green-600' :
