...
function AdminDashboard() {
  ...
  const Sidebar = ({ mobile = false }) => (
    <aside className={`${mobile ? 'w-full' : 'w-64'} bg-afri-gray-900 flex flex-col h-full`}>
      {/* Logo */}
        ...
        <header className="bg-white border-b border-afri-gray-100 px-6 py-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            <button
              ...
              className="lg:hidden w-9 h-9 bg-afri-gray-50 rounded-xl flex items-center justify-center"
            >
          ...
          <div className="flex items-center gap-2">
            <button onClick={fetchAdminStats} className="w-9 h-9 bg-afri-gray-50 rounded-xl flex items-center justify-center hover:bg-afri-gray-100 transition-colors">
                ...
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="bg-white rounded-2xl p-5 shadow-sm border border-afri-gray-100">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      { label: 'Active Orders',    value: stats?.orders   || 0,                       icon: ShoppingBag, color: 'text-afri-yellow-dark', bg: 'bg-afri-yellow-light' },
                        ...
                        {stats.recentOrders.map(order => {
                          ...
                          return (
                            <tr key={order._id} className="hover:bg-afri-gray-50 transition-colors">
                              ...
                              <td className="px-5 py-3.5 font-bold text-afri-gray-900">£{order.pricing?.total?.toFixed(2) || '0.00'}</td>
