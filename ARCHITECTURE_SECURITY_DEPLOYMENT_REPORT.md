...
**URI:** `mongodb+srv://africa:***@afrihub.lmp2s8m.mongodb.net/afrimercato`  
**Cluster:** Afrihub (region not specified in code)
...
| **Email Delivery** | Gmail SMTP | Notifications, password reset | [.env](afrimercato-backend/.env) - EMAIL_HOST=smtp.gmail.com |
...
# Database
MONGODB_URI=mongodb+srv://africa:***@afrihub.lmp2s8m.mongodb.net/afrimercato

# JWT
JWT_SECRET=<long-random-string>
JWT_EXPIRE=7d
JWT_REFRESH_SECRET=<different-long-string>
JWT_REFRESH_EXPIRE=30d

# Cloudinary
CLOUDINARY_CLOUD_NAME=darrrqhgn
CLOUDINARY_API_KEY=225162814767275
CLOUDINARY_API_SECRET=***

# Stripe (Test Mode)
STRIPE_PUBLISHABLE_KEY=pk_test_51SvlJ7Ps36puK864...
STRIPE_SECRET_KEY=sk_test_51SvlJ7Ps36puK864...
STRIPE_WEBHOOK_SECRET=whsec_j9Cy9CkIaMZZQJFvNCGrUcIOw8iMbNqp
