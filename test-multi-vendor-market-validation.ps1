...
Write-Host "  Backend: https://afrimercato-backend.onrender.com"
...
Write-Host "Open Swagger: https://afrimercato-backend.onrender.com/api-docs`n" -ForegroundColor Yellow
