...
Write-Host "  Backend: https://afrimercato-backend-1.onrender.com"
...
Write-Host "Open Swagger: https://afrimercato-backend-1.onrender.com/api-docs`n" -ForegroundColor Yellow
